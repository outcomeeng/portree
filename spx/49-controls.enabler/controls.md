...
- Given a valid `.portree.toml` and all services reachable, when `portree doctor` is run, then the command exits with status 0 ([test](tests/controls_compliance_l2_test.go))
